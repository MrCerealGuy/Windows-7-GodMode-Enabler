...
namespace Win7GodMode
{
    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            {
                String strPath = Environment.GetEnvironmentVariable("USERPROFILE") + "\\Desktop\\GodMode.{ED7BA470-8E54-465E-825C-99712043E01C}";

                // create "GodMode" directory on desktop
                try
                {
                ...
                {
                    MessageBox.Show("Activating GodMode failed: " + e.ToString(), "Windows 7 GodMode Enabler", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                finally
                {
                ...
                // create context menu
                RegistryKey rkCLSID = Registry.ClassesRoot.OpenSubKey("CLSID\\{20D04FE0-3AEA-1069-A2D8-08002B30309D}\\shell", true);
                RegistryKey rkGodMode = rkCLSID.CreateSubKey("GodMode");
                RegistryKey rkCommand = rkGodMode.CreateSubKey("command");

                rkGodMode.SetValue("Icon", "%SystemRoot%\\System32\\imageres.dll,-109");
                rkCommand.SetValue(null, "explorer.exe shell:::{ED7BA470-8E54-465E-825C-99712043E01C}");
            }
            else
                MessageBox.Show("Windows 7 or higher required!", "Windows 7 GodMode Enabler", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
